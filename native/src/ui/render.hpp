...
struct MaterialParameter final {
    std::string name;
    runtime::Value value;
    [[nodiscard]] friend bool operator==(const MaterialParameter&, const MaterialParameter&) = default;
};
...
struct SolidRectRenderCommand final {
    Rect bounds;
    Paint fill;
    [[nodiscard]] friend bool operator==(const SolidRectRenderCommand&, const SolidRectRenderCommand&) = default;
};
struct RoundedRectRenderCommand final {
    ...
    double softness = 1.0;
    [[nodiscard]] friend bool operator==(const RoundedRectRenderCommand&, const RoundedRectRenderCommand&) = default;
};
struct BorderRenderCommand final {
    Rect bounds;
    RenderBorder border;
    CornerRadii radii;
    [[nodiscard]] friend bool operator==(const BorderRenderCommand&, const BorderRenderCommand&) = default;
};
struct ImageRenderCommand final {
    ...
    [[nodiscard]] friend bool operator==(const ImageRenderCommand&, const ImageRenderCommand&) = default;
};
struct NinePatchRenderCommand final {
    ...
    RenderColor tint{255U, 255U, 255U, 255U};
    [[nodiscard]] friend bool operator==(const NinePatchRenderCommand&, const NinePatchRenderCommand&) = default;
};
...
struct CustomMeshRenderCommand final {
    ...
    double opacity = 1.0;
    [[nodiscard]] friend bool operator==(const CustomMeshRenderCommand&, const CustomMeshRenderCommand&) = default;
};
/** One authored vector shape: an outline plus how it is filled, stroked, or both. */
struct PathRenderCommand final {
    Rect bounds;
    PathShape shape;
    [[nodiscard]] friend bool operator==(const PathRenderCommand&, const PathRenderCommand&) = default;
};
struct BlurRegionRenderCommand final {
    Rect bounds;
    double radius = 0.0;
    std::size_t downsample = 1U;
    [[nodiscard]] friend bool operator==(const BlurRegionRenderCommand&, const BlurRegionRenderCommand&) = default;
};
...
struct TransformPushRenderCommand final {
    ...
    double m11 = 1.0;
    double m12 = 0.0;
    [[nodiscard]] friend bool operator==(const TransformPushRenderCommand&, const TransformPushRenderCommand&) = default;
};
struct TransformPopRenderCommand final {
    [[nodiscard]] friend bool operator==(TransformPopRenderCommand, TransformPopRenderCommand) = default;
};
struct MaterialPushRenderCommand final {
    MaterialState material;
    [[nodiscard]] friend bool operator==(const MaterialPushRenderCommand&, const MaterialPushRenderCommand&) = default;
};
struct MaterialPopRenderCommand final {
    [[nodiscard]] friend bool operator==(MaterialPopRenderCommand, MaterialPopRenderCommand) = default;
};
...
struct RenderOperationCounters final {
    ...
    [[nodiscard]] friend bool operator==(const RenderOperationCounters&, const RenderOperationCounters&) = default;
};
...
public:
    ...
    [[nodiscard]] RenderOperationCounters render(
    ...
    [[nodiscard]] std::vector<RenderCommand> snapshot_subtree(
