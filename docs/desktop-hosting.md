...
Both paths use the same public C ABI, packet-v9 decoder, D3D11 renderer, resource loader,
...
Surface, decodes packet v9, submits D3D11 work, and presents. `close()` is optional during ordinary
