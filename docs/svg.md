...
PNG bytes are inspected at Surface creation, transferred once through packet v9, decoded by the
...
renderer, or a custom packet-v9 backend. Both desktop and headless rendering consume the same
