...
PNG bytes are inspected at Surface creation, transferred once through packet v8, decoded by the
...
renderer, or a custom packet-v8 backend. Both desktop and headless rendering consume the same
