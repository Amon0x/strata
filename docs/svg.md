...
PNG bytes are inspected at Surface creation, transferred once through packet v5, decoded by the
...
renderer, or a custom packet-v5 backend. Both desktop and headless rendering consume the same
